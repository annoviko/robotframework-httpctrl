...
cd src || exit $EXIT_CODE_INCORRECT_PATH
python3 -m robot.libdoc -v 0.1.6 -F reST HttpCtrl.Client client.html
python3 -m robot.libdoc -v 0.1.6 -F reST HttpCtrl.Server server.html
python3 -m robot.libdoc -v 0.1.6 -F reST HttpCtrl.Json json.html
